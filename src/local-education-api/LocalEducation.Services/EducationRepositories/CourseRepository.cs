...
public class CourseRepository : ICourseRepository
{
	...
	{
		DbSet<Course> course = _context.Set<Course>();
	...
	public async Task<Course> GetCourseBySlugAsync(string slug, CancellationToken cancellationToken = default)
	{
		...
		List<Lesson> lessons = await _context.Set<Lesson>()
			.Include(l => l.Slides)
	...
	{
		IQueryable<Course> courses = FilterCourses(condition);

		IQueryable<T> projectedCourses = mapper(courses);
