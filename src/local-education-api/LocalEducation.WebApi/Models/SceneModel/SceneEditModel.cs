...
public class SceneEditModel
{
    ...
    public IList<LinkHotspotEditModel> LinkHotspots { get; set; } = new List<LinkHotspotEditModel>();

    public IList<InfoHotspotEditModel> InfoHotspots { get; set; } = new List<InfoHotspotEditModel>();
