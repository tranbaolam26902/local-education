...
namespace LocalEducation.Data.Migrations
{
    ...
    partial class LocalEducationDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocalEducation.Core.Entities.Option", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LocalEducation.Core.Entities.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LocalEducation.Core.Entities.ResultDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LocalEducation.Core.Entities.Option", b =>
                {
                    b.HasOne("LocalEducation.Core.Entities.Question", "Question")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("LocalEducation.Core.Entities.Question", b =>
                {
                    b.HasOne("LocalEducation.Core.Entities.Slide", "Slide")
                        .WithMany("Questions")
